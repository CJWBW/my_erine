...
def main():
    ...
    tokenizer = BertTokenizer.from_pretrained(ERNIE_BASE_PATH, do_lower_case=True)
    ...
    ErnieModel.train_model(model, train_dataloader, validation_dataloader, EPOCHS, device, loss_fn, embed)

    # evaluate model on test dataset
    test_acc, test_loss = ErnieModel.eval_model(model, test_dataloader, device, embed)
